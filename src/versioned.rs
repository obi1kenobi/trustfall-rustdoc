    ...
    pub fn from_storage(storage: &'a VersionedStorage, target_triple: &str) -> Self {
        match storage {
            ...
            VersionedStorage::V37(s) => {
                Self::V37(trustfall_rustdoc_adapter_v37::PackageIndex::from_storage(s, target_triple))
            }

            #[cfg(feature = "v39")]
            VersionedStorage::V39(s) => {
                Self::V39(trustfall_rustdoc_adapter_v39::PackageIndex::from_storage(s, target_triple))
            }

            #[cfg(feature = "v43")]
            VersionedStorage::V43(s) => {
                Self::V43(trustfall_rustdoc_adapter_v43::PackageIndex::from_storage(s, target_triple))
            }
