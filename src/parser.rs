...
pub fn load_rustdoc(path: &Path) -> anyhow::Result<VersionedCrate> {
    ...
    match format_version {
        #[cfg(feature = "v21")]
        21 => Ok(VersionedCrate::V21(parse_or_report_error(
            path,
            &file_data,
            format_version,
        )?)),
        ...
        #[cfg(feature = "v22")]
        22 => Ok(VersionedCrate::V22(parse_or_report_error(
            path,
            &file_data,
            format_version,
        )?)),
        ...
        #[cfg(feature = "v23")]
        23 => Ok(VersionedCrate::V23(parse_or_report_error(
            path,
            &file_data,
            format_version,
        )?)),
        ...
        #[cfg(feature = "v24")]
        24 => Ok(VersionedCrate::V24(parse_or_report_error(
            path,
            &file_data,
            format_version,
        )?)),
        ...
        #[cfg(feature = "v25")]
        25 => Ok(VersionedCrate::V25(parse_or_report_error(
            path,
            &file_data,
            format_version,
        )?)),
